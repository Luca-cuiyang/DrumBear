...
#endif
    QCoreApplication::setOrganizationName("DrumBear");
    QCoreApplication::setOrganizationDomain("drumbear.app");
...
#endif
    QGuiApplication::setDesktopFileName("app.drumbear.DrumBear" MUSE_APP_INSTALL_SUFFIX);
#endif
